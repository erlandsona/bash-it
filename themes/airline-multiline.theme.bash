...
function powerline_prompt_command() {
    ...
    LEFT_PROMPT="${SHELL_PROMPT}${SCM_PROMPT}${VIRTUALENV_PROMPT}${RVM_PROMPT}${CWD_PROMPT}${MOVE_CURSOR_RIGHTMOST}"
    ...
    #####\[$(retval=$?;tput cup "$LINES";exit $retval)\]#### This piece keeps the prompt at the bottom of the screen and keeps the exit code.
    PS1="\[$(retval=$?;tput cup "$LINES";exit $retval)\]${LEFT_PROMPT}\n${LAST_STATUS_PROMPT}${PROMPT_CHAR}"
}
